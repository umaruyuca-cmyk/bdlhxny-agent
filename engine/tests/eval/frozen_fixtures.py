...
FROZEN_RESPONSES: list[tuple[str, str, dict[str, Any]]] = [
    ...
    (
        ...
        "analysis.run_analysis",
        {
            "score": 72,
            "rating": "中性偏强",
            "dimensions": {"technical": 78, "fundamental": 74, "valuation": 52, "money_flow": 65, "sentiment": 71},
    ...
    (
        ...
        "research.deep_search",
        {
            "question": "宁德时代投资价值综合评估",
            "objective": "多源交叉验证基本面与估值",
...
NEGATIVE_RESPONSES: list[tuple[str, str, str, dict[str, Any]]] = [
    ...
    (
        "market.resolve_instrument:000000",
        "market.resolve_instrument",
        "SUCCESS",
        {"symbol": "000000", "name": None, "exchange": None, "industry": None},
    ),
    ("market.resolve_instrument:999999", "market.resolve_instrument", "ERROR", {"error": "symbol not found"}),
    ("market.resolve_instrument:888888", "market.resolve_instrument", "TIMEOUT", {"error": "resolve service timeout"}),
    (
        "market.get_realtime_quote:000000",
        "market.get_realtime_quote",
        "SUCCESS",
        {
            "symbol": "000000",
    ...
    ("market.get_realtime_quote:999999", "market.get_realtime_quote", "ERROR", {"error": "symbol not found"}),
    ("market.get_realtime_quote:888888", "market.get_realtime_quote", "TIMEOUT", {"error": "quote service timeout"}),
    (
        "market.get_valuation:000000",
        "market.get_valuation",
        "SUCCESS",
        {"symbol": "000000", "pe_ttm": None, "pb": None, "pe_percentile": None, "pb_percentile": None},
    ),
    ("market.get_valuation:999999", "market.get_valuation", "ERROR", {"error": "symbol not found"}),
    ("market.get_valuation:888888", "market.get_valuation", "TIMEOUT", {"error": "valuation service timeout"}),
    (
        "market.get_financial_statements:000000",
        "market.get_financial_statements",
        "SUCCESS",
        {"symbol": "000000", "revenue_yoy": None, "net_margin": None, "roe": None, "gross_margin": None},
    ),
    (
        "market.get_financial_statements:999999",
        "market.get_financial_statements",
        "ERROR",
        {"error": "symbol not found"},
    ),
    (
        "market.get_financial_statements:888888",
        "market.get_financial_statements",
        "TIMEOUT",
        {"error": "filings service timeout"},
    ),
    (
        "market.get_historical_prices:000000",
        "market.get_historical_prices",
        "SUCCESS",
        {"symbol": "000000", "prices": []},
    ),
    ("market.get_historical_prices:999999", "market.get_historical_prices", "ERROR", {"error": "symbol not found"}),
    (
        "market.get_historical_prices:888888",
        "market.get_historical_prices",
        "TIMEOUT",
        {"error": "history service timeout"},
    ),
    (
        "market.get_industry_context:000000",
        "market.get_industry_context",
        "SUCCESS",
        {"industry": None, "rank": None, "market_share": None, "industry_pe_median": None},
    ),
    ("market.get_industry_context:999999", "market.get_industry_context", "ERROR", {"error": "symbol not found"}),
    (
        "market.get_industry_context:888888",
        "market.get_industry_context",
        "TIMEOUT",
    ...
    ("market.get_money_flow:000000", "market.get_money_flow", "SUCCESS", {"net_inflow": None, "items": []}),
    ("market.get_money_flow:999999", "market.get_money_flow", "ERROR", {"error": "symbol not found"}),
    ("market.get_money_flow:888888", "market.get_money_flow", "TIMEOUT", {"error": "money flow service timeout"}),
